...
def main():
    ...
    parser.add_argument("--num-samples", type=int, default=1, help="Number of iterations to run the model.")
    parser.add_argument("--minibatch-size", type=int, default=100, help="Minibatch size for inferring effect prediction.")
    parser.add_argument("--dropout-p", type=float, default=1., help="Dropout p while sampling log p(x).")
