...
$HOME/miniconda2/bin/python -c "from tensorflow.python.client import device_lib; print device_lib.list_local_devices()"  # test GPU install

# download SeqDesign code
# git clone https://github.com/debbiemarkslab/SeqDesign.git
# cd SeqDesign || exit
$HOME/miniconda2/bin/python setup.py install  # use setup.py develop if you want to modify the code files
