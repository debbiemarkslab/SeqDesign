...
# Before running this script, first run `git clone -b v2 https://github.com/debbiemarkslab/SeqDesign.git`
...
# git clone -b v2 https://github.com/debbiemarkslab/SeqDesign.git
# cd SeqDesign || exit
